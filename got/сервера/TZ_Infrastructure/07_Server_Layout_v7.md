...
| H20 | **helsinki-gw** | 10.1.0.40 | CPX22 (2 vCPU / 4 GB) | €12 | Firewall/Router: Debian 12 + MikroTik CHR (KVM). WireGuard endpoint для всех локальных серверов, routing 10.2.0.0/24 ↔ 10.1.0.0/16 | 🆕 Создать |
